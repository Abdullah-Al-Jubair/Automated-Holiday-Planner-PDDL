(define (problem linehaul_example)
    ...
    (:init
        (= (already_visited) 0)
        (at TourTravelsBus depot)
        ; (visited_spots TourTravelsBus spot10)
        (spot_visiting GV spot3)
        (spot_visiting E spot5)
        (spot_visiting BW spot2)
    ...
    (:goal (and 
            (= (already_visited) 10)
            (spot_visiting GV spot0)
            (spot_visiting E spot0)
            (spot_visiting BW spot0)
            (at TourTravelsBus depot)
            (tour_ending_spot depot)
           )
	)
